...
class DictionaryPutRequest extends FormRequest
{
    ...
    #[ArrayShape(['id.required' => 'string', 'dictionary_name.required' => "string", 'creator_id.required' => "string", 'creator_id.integer' => 'string'])]
