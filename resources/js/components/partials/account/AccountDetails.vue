<template>
    <div
        class="tab-pane fade show active position-absolute top-0 start-30"
        id="account-details-pane" role="tabpanel" aria-labelledby="pills-account-details-tab" tabindex="0">
        ...
        <form>
            ...
            <div class="mb-3 form-check">
                ...
                <label class="form-check-label" for="notifyCheckbox">Sent me notifications</label>
            </div>
            <div class="row g-2">
                <div class="col-md">
                    <div class="form-floating">
